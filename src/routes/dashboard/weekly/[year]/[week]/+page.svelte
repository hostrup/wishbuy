...
>
	...
	<div
		class="pointer-events-none absolute top-0 left-1/4 h-[500px] w-[500px] rounded-full bg-rose-500/10 blur-3xl dark:bg-rose-600/10"
	></div>
	<div
		...
		>
			<div>
				<div class="flex items-center gap-2">
					<a
						href="/"
						class="flex items-center gap-1 text-xs font-bold text-rose-600 hover:text-rose-500 dark:text-rose-400 dark:hover:text-rose-300"
					>
						<ArrowLeft size={12} /> Tilbage til Hubben
					</a>
				</div>
				<h1
					class="mt-1 bg-gradient-to-r from-rose-600 to-rose-400 bg-clip-text text-3xl font-black tracking-tight text-transparent md:text-5xl dark:from-rose-400 dark:to-rose-300"
				>
					Ugeplan & Madplan
				</h1>
		...
		<div class="flex items-center justify-between">
			...
			<div class="flex flex-col items-center select-none">
				<div class="relative flex flex-col items-center">
					...
					>
					<span
						class="bg-gradient-to-r from-rose-600 to-rose-400 bg-clip-text text-3xl font-black text-transparent md:text-4xl"
					>
						Uge {currentWeek}
					</span>
					<!-- Mini dots indicator -->
					<div class="mt-2 flex gap-1">
						{#each Array(7) as _, i}
							...
							<div
								...
								{hasRecipe
									? 'bg-rose-500 shadow-[0_0_6px_rgba(232,135,158,0.5)]'
			...
			<div class="space-y-5 lg:col-span-4">
				...
				>
					...
					<div class="h-2 overflow-hidden rounded-full bg-slate-100 dark:bg-slate-900">
						<div
							class="relative h-full overflow-hidden rounded-full bg-rose-500 transition-all duration-1000 ease-out dark:bg-rose-400"
							style="width: {mealProgress}%; shadow: 0 0 12px rgba(232,135,158,0.4);"
						></div>
					</div>
					<!-- Day dots below bar -->
				...
				>
					<div class="mb-4 flex items-center justify-between">
						<div class="flex items-center gap-2">
							<div
								class="flex h-8 w-8 items-center justify-center rounded-xl border border-rose-500/20 bg-rose-500/10"
							>
								<svg
									width="14"
									height="14"
						...
						{#if isSavingWeekNote}
							<Loader2 size={12} class="animate-spin text-rose-500" />
						{:else}
							<CheckCircle2
								size={12}
					...
					>
						...
						<button
							type="submit"
							class="mt-3 w-full cursor-pointer rounded-2xl bg-rose-600 py-2.5 text-sm font-bold text-white shadow-lg transition-all hover:bg-rose-500"
						>
							Gem noter
						</button>
					</form>
				...
				<!-- SHOPPING TEASER -->
				<div
					class="relative overflow-hidden rounded-3xl border border-dashed border-rose-200 bg-rose-50/50 p-5 dark:border-rose-900/30 dark:bg-rose-950/10"
				>
					<div class="mb-2 flex items-center gap-2">
						...
						<h3
							class="text-xs font-black tracking-wider text-rose-700 uppercase dark:text-rose-300"
						>
							Indkøbsliste
						</h3>
					</div>
					<p class="text-[11px] leading-relaxed text-slate-500 dark:text-slate-400">
						Automatisk indkøbsliste fra ugens opskrifter. <span
							class="font-bold text-rose-600 dark:text-rose-400">Coming soon</span
						>
					</p>
				</div>
			</div>
